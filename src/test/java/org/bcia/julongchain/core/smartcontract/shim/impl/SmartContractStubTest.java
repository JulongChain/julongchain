...
import static org.bcia.julongchain.protos.common.Common.HeaderType.ENDORSER_TRANSACTION_VALUE;
...
public class SmartContractStubTest {
    ...
    public void createCompositeKey() {
        final SmartContractStub stub = new SmartContractStub("myc", "txId", handler, Collections.emptyList(), null);
        final org.bcia.julongchain.core.smartcontract.shim.ledger.CompositeKey key = stub.createCompositeKey("abc", "def", "ghi", "jkl", "mno");
    ...
    public void splitCompositeKey() {
        final SmartContractStub stub = new SmartContractStub("myc", "txId", handler, Collections.emptyList(), null);
        final org.bcia.julongchain.core.smartcontract.shim.ledger.CompositeKey key = stub.splitCompositeKey("\u0000abc\u0000def\u0000ghi\u0000jkl\u0000mno\u0000");
        assertThat(key, hasProperty("objectType", equalTo("abc")));
