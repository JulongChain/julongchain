...
import org.bcia.javachain.peer.entity.PeerChannel;
 ...
 * @company Dingxuan
 */
public abstract class PeerChannelCmd implements IPeerCmd{

	protected PeerChannel peerChannel;

	public PeerChannelCmd(){
