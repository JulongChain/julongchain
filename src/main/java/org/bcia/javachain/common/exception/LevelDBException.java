 ...
 * @company Dingxuan
 */
public class LevelDBException extends LedgerException {

    private static final String MODULE_NAME = "[LevelDB]";
    ...
    protected LevelDBException(String message, Throwable cause,
