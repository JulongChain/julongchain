...
public class Node2 {
	...
	public static void main(String[] args) throws Exception {
		...
		GossipMember gossipMember = new RemoteGossipMember("bcia-gossip-cluster", URI.create("udp://localhost:3000"), "1");
		...
		// 创建gossip service
		GossipService gossipService = new GossipService("bcia-gossip-cluster", URI.create("udp://localhost:3001"), "2",
		...
		while (true) {
			...
			m.setKey("abc");
			m.setPayload(new OrSet<String>("from node2:" + UUID.randomUUID().toString()));
