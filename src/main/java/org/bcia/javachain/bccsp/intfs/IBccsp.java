package org.bcia.javachain.bccsp.intfs;
...
/**
 * @author zhanglin
 * @purpose Define the interface, IBccsp, and list its elements
 * @date 2018-01-25
 * @company Dingxuan
 */

// IBccsp is the blockchain cryptographic service provider that offers implementations of
// cryptographic algorithms, such as NIST, GM(P.R.China's standards) and so on.
public interface IBccsp {
