 ...
 */
package org.bcia.javachain.tools.configtxgen.cmd.factory;
...
import org.bcia.javachain.tools.configtxgen.ConfigtxGenConstant;
import org.bcia.javachain.tools.configtxgen.cmd.ConfigtxVersionCmd;
import org.bcia.javachain.tools.configtxgen.cmd.IConfigtxGenCmd;
 ...
 * @company Dingxuan
 */
public class ConfigtxGenCmdFactory {
//    public static IConfigtxGenCmd getInstance(String command, String subCommand) {
...
//            }
//        } else if (ConfigtxGenConstant.VERSION.equalsIgnoreCase(command)) {
//            return new ConfigtxVersionCmd();
//        }
//
//        return null;
//    }
