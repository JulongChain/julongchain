...
import org.bcia.javachain.csp.intfs.opts.IEncrypterOpts;
 ...
 * @company FEITIAN
 */
public enum AesEncrypterOpts implements IEncrypterOpts {
    ...
    private AesEncrypterOpts(String padding,String mode, long mechanism, int index) {
