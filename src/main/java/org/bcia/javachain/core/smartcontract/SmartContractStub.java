...
import org.bcia.javachain.core.ledger.KeyModification;
import org.bcia.javachain.core.ledger.KeyValue;
...
public class SmartContractStub implements ISmartContractStub {
	...
	public QueryResultsIterator<KeyValue> getStateByRange(String startKey, String endKey) {
		...
		return new QueryResultsIteratorImpl<KeyValue>(this.handler, getGroupId(), getTxId(),
	...
	public QueryResultsIterator<KeyModification> getHistoryForKey(String key) {
		return new QueryResultsIteratorImpl<KeyModification>(this.handler, getGroupId(), getTxId(),
