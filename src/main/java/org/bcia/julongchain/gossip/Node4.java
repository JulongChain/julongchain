 ...
 */
public class Node4 {
	private static JavaChainLog log = JavaChainLogFactory.getLog(Node4.class);
	...
	public static void main(String[] args) throws Exception {
		...
		// 创建gossip service
		GossipService gossipService = new GossipService("bcia-gossip-cluster", URI.create("udp://localhost:3003"), "4",
		...
		while (true) {
			...
			m.setKey("abc");
			m.setPayload(new OrSet<String>("from node4" + UUID.randomUUID().toString()));
