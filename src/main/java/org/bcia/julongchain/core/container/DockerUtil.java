...
public class DockerUtil {
  ...
  /** build name */
  private static final String BUILD_NAME = "julongchain";

  /** source path */
  private static final String SOURCE_PATH =
      "/var/lib/jenkins/workspace/"
          + BUILD_NAME
          + "/src/main/java/org/bcia/julongchain/core/smartcontract/client/";

  /** jar path */
  private static final String JAR_PATH =
      "/var/lib/jenkins/workspace/" + BUILD_NAME + "/target/julongchain-jar-with-dependencies.jar";
  ...
  public static String createContainer(String imageId, String containerName) {
    String containerId =
        getDockerClient()
            ...
            .withCmd("/bin/sh", "-c", "java -jar /root/julongchain/target/julongchain-smartcontract-java-jar-with-dependencies.jar -i mycc")
            .exec()
            .getId();
  ...
  public static void main(String[] args) throws Exception {
    // buildImage("/root/julongchain/images/scenv/Dockerfile", "julongchain-baseimage1");
    // buildImage("/root/instantiate/Dockerfile", "julongchain-baseimage4");
    // DockerClient dockerClient = getDockerClient();
    ...
    // String s = "java -jar /root/julongchain/target/julongchain-smartcontract-java-jar-with-dependencies.jar -i mycc\r\n";
    //
