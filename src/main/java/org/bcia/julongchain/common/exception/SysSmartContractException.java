 ...
 * @company Dingxuan
 */
public class SysSmartContractException extends JulongChainException {
    ...
    public SysSmartContractException(String message) {
        super(MODULE_NAME + message);
    }

    public SysSmartContractException(String message, Throwable cause) {
        super(MODULE_NAME + message, cause);
    }


    public SysSmartContractException(Throwable cause) {
        super(cause);
    }
