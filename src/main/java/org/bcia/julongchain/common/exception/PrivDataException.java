...
public class PrivDataException extends JavaChainException {
	...
	public PrivDataException(String message) {
		super(MODULE_NAME + message);
	}

	public PrivDataException(String message, Throwable cause) {
		super(MODULE_NAME + message, cause);
	}


	public PrivDataException(Throwable cause) {
		super(cause);
	}


	protected PrivDataException(String message, Throwable cause,
