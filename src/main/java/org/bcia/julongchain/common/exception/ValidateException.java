 ...
 * @company Dingxuan
 */
public class ValidateException extends JulongChainException {
    private static final String MODULE_NAME = "[Validate]";
    ...
    protected ValidateException(String message, Throwable cause,
